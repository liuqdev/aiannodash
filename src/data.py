...
class LiverDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        # Ex. MCUCXR_0023_0 MCUCXR_0023_0
        ...
        # 0-255 ==> 0-1  ==> -0.5 - +0.5
        origin = torchvision.transforms.functional.to_tensor(origin) - 0.5  # 在这里减了, 之后要加上去
